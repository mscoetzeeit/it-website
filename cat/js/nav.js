...
(function () {
  ...
  var html = '<nav class="topnav">'
    ...
    + '<div class="dropdown-section">' + t('Printable Booklets (English)', 'Drukbare Boekies (Engels)') + '</div>'
    ...
    + '<div class="dropdown-section">' + t('Printable Booklets (Afrikaans)', 'Drukbare Boekies (Afrikaans)') + '</div>'
    + '<a href="' + r + 'booklet-gr10-af.html">&#128218; ' + t('Grade 10 &mdash; Drukbare Boekie', 'Graad 10 &mdash; Drukbare Boekie') + '</a>'
    + '<a href="' + r + 'booklet-gr11-af.html">&#128218; ' + t('Grade 11 &mdash; Drukbare Boekie', 'Graad 11 &mdash; Drukbare Boekie') + '</a>'
    + '<a href="' + r + 'booklet-gr12-af.html">&#128218; ' + t('Grade 12 &mdash; Drukbare Boekie', 'Graad 12 &mdash; Drukbare Boekie') + '</a>'
    + '</div></li>'
