...
(function () {
  ...
  var html = '<nav class="topnav">'
    ...
    + '<div class="dropdown-section">Theory</div>'
    + '<a href="' + r + 'grade11/theory/hardware-gr11.html">Motherboard &amp; Hardware</a>'
    + '<a href="' + r + 'grade11/theory/processing.html">Processing Techniques</a>'
    + '<a href="' + r + 'grade11/theory/databases.html">Database Management</a>'
    + '<a href="' + r + 'grade11/theory/networks-gr11.html">Networks &amp; Protocols</a>'
    + '<a href="' + r + 'grade11/theory/mobile-tech.html">Mobile Technology</a>'
    + '<a href="' + r + 'grade11/theory/computer-management.html">Computer Management</a>'
    + '<a href="' + r + 'grade11/theory/e-communications-gr11.html">E-Communications</a>'
    + '<a href="' + r + 'grade11/theory/internet-gr11.html">Internet &amp; Multimedia</a>'
    + '<a href="' + r + 'grade11/theory/internet-services-gr11.html">Internet Services</a>'
    + '<a href="' + r + 'grade11/theory/social-gr11.html">Social Implications</a>'
    + '</div></li>'
    ...
    + '<div class="dropdown">'
    + '<div class="dropdown-section">Practical</div>'
    + '<a href="' + r + 'grade12/sql.html">SQL (T1)</a>'
    + '<a href="' + r + 'grade12/sql-join.html">SQL &mdash; Joining Tables (T1)</a>'
    + '<a href="' + r + 'grade12/oop.html">OOP (T2)</a>'
    + '<a href="' + r + 'grade12/arrays-2d.html">2D Arrays (T2)</a>'
    + '<a href="' + r + 'grade12/recursion.html">Recursion (T2)</a>'
    + '<div class="dropdown-section">Theory</div>'
    + '<a href="' + r + 'grade12/data-management.html">Data Collection &amp; Warehousing</a>'
    + '<a href="' + r + 'grade12/relational-db.html">Relational Databases &amp; Normalisation</a>'
    + '<a href="' + r + 'grade12/hardware-gr12.html">Hardware &amp; Performance</a>'
    + '<a href="' + r + 'grade12/cloud-vr-ar.html">Cloud Computing, AI, VR &amp; AR</a>'
    + '<a href="' + r + 'grade12/internet-tech.html">Internet Technologies</a>'
    + '<a href="' + r + 'grade12/networks-gr12.html">Networks &amp; Remote Access</a>'
    + '<a href="' + r + 'grade12/communication-tech.html">Communication Technologies</a>'
    + '<a href="' + r + 'grade12/cybercrime.html">Cybercrime &amp; Safeguards</a>'
    + '<a href="' + r + 'grade12/social-gr12.html">Social Implications</a>'
    + '</div></li>'
