...
(function () {
  ...
  var html = '<nav class="topnav">'
    ...
    + '<a href="' + r + 'grade10/practical/algorithms.html">Algorithms &amp; Problem Solving (T1)</a>'
    + '<a href="' + r + 'grade10/practical/delphi-intro.html">Introduction to Delphi (T1)</a>'
    + '<a href="' + r + 'grade10/practical/delphi-components.html">Delphi Components &amp; Events (T2&ndash;T3)</a>'
    + '<a href="' + r + 'grade10/practical/data-types.html">Data Types &amp; Variables (T1)</a>'
    + '<a href="' + r + 'grade10/practical/operators.html">Operators &amp; Functions (T1&ndash;T3)</a>'
    + '<a href="' + r + 'grade10/practical/decisions.html">Decision Making (IF / CASE) (T1&ndash;T2)</a>'
    + '<a href="' + r + 'grade10/practical/loops.html">Loops (T3)</a>'
    + '<a href="' + r + 'grade10/practical/strings.html">String Manipulation (T2&ndash;T3)</a>'
    + '<div class="dropdown-section">Theory</div>'
    + '<a href="' + r + 'grade10/theory/digital-tech.html">Digital Technologies &amp; ICT (T1)</a>'
    + '<a href="' + r + 'grade10/theory/hardware.html">Hardware (T2)</a>'
    + '<a href="' + r + 'grade10/theory/software.html">Software &amp; Licensing (T1&ndash;T2)</a>'
    + '<a href="' + r + 'grade10/theory/data-representation.html">Data Representation (T1)</a>'
    + '<a href="' + r + 'grade10/theory/networks.html">Networks (T2)</a>'
    + '<a href="' + r + 'grade10/theory/internet.html">Internet &amp; WWW (T3)</a>'
    + '<a href="' + r + 'grade10/theory/internet-services.html">Internet Services (T4)</a>'
    + '<a href="' + r + 'grade10/theory/e-communication.html">E-Communication (T2)</a>'
    + '<a href="' + r + 'grade10/theory/management.html">Computer Management &amp; Security (T3)</a>'
    + '</div></li>'
