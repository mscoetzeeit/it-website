...
const PAGES = [
  ...
  { title: 'Data Representation',              url: 'grade10/theory/data-representation.html',    grade: 'Grade 10 · Theory',    tags: 'binary hex decimal ascii unicode bits bytes number systems conversion video compression container codec h.264 h.265 mp4 mkv' },
  { title: 'Networks (Gr 10)',                 url: 'grade10/theory/networks.html',               grade: 'Grade 10 · Theory',    tags: 'network lan wan pan client server peer topology nic router switch modem bus ring mesh star wired wireless' },
  ...
  { title: 'OOP (Gr 12)',                       url: 'grade12/oop.html',                           grade: 'Grade 12 · Practical', tags: 'oop class object constructor accessor mutator encapsulation inheritance polymorphism uml private public tostring auxiliary parameterised non-parameterised' },
  ...
  // Grade 12 Theory
  { title: 'Data Collection & Warehousing',    url: 'grade12/data-management.html',               grade: 'Grade 12 · Theory',    tags: 'data collection warehouse mining rfid cookie transaction loyalty card static dynamic location metadata centralised distributed database' },
  ...
  { title: 'Cloud Computing, AI, VR & AR',      url: 'grade12/cloud-vr-ar.html',                   grade: 'Grade 12 · Theory',    tags: 'cloud computing saas virtual reality augmented reality mixed reality virtualisation ai artificial intelligence machine learning accountability data ownership' },
  ...
  { title: 'Networks & Remote Access (Gr 12)', url: 'grade12/networks-gr12.html',                 grade: 'Grade 12',             tags: 'adsl fibre wimax 4g 5g satellite vpn remote access sharing bittorrent cloud storage permission han' },
  { title: 'Communication Technologies',       url: 'grade12/communication-tech.html',            grade: 'Grade 12',             tags: 'adsl wimax 5g vpn encryption ssl otp mfa security token firewall bittorrent remote access risks password policy' },
  ...
  { title: 'Social Implications (Gr 12)',      url: 'grade12/social-gr12.html',                   grade: 'Grade 12',             tags: 'big data social media privacy digital footprint globalisation 4ir cookies anonymity guid popia iot internet of things smart home accessibility' },
  // Quick Reference
